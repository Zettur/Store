...
namespace Store.Contractors
{
    public class PostamateDeliveryService : IDeliveryService
    {
        ...
        public string Title => "Доставка через постаматы в Москве, Санкт-Перербурге и Казани";
        ...
        public Form NextForm(int step, IReadOnlyDictionary<string, string> values)
        {
            if (step == 1)
            {
                ...
                {
                    return Form.CreateNext(Name, 2, values)
                               .AddField(new SelectionField("Постамат", "postamate", "3", postamates["3"]));
                }
                else
        ...
        public OrderDelivery GetDelivery(Form form)
        {
            ...
            return new OrderDelivery(Name, description, 15m, parameters);
        }
    }
}
